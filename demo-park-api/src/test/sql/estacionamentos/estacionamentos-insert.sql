...
insert into clientes_tem_vagas (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
    values ('20250129-180500', 'FIT-1020', 'FIAT', 'PALIO', 'VERDE', '2025-01-29 10:05:00', 22, 100);
insert into clientes_tem_vagas (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
    values ('20250130-180400', 'SIE-1020', 'FIAT', 'SIENA', 'BRANCO', '2025-01-30 10:04:00', 21, 200);
insert into clientes_tem_vagas (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
    values ('20250130-180500', 'FIT-1020', 'FIAT', 'PALIO', 'VERDE', '2023-01-30 10:05:00', 22, 300);